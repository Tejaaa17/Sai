                  ...
                  >
                    <div className="carousel-inner">
                      <div className="carousel-item active">
                        <img
                          src="/assets/images/ecommerce/products/grid/pic1.png"
                      ...
                      <div className="carousel-item">
                        <img
                          src="/assets/images/ecommerce/products/grid/pic2.png"
                          className="d-block img-fluid"
                          alt="Product view 2"
                        />
                      </div>
                      <div className="carousel-item">
                        <img
                          src="/assets/images/ecommerce/products/grid/pic3.png"
                          className="d-block img-fluid"
                          alt="Product view 3"
                        />
                      </div>
                      <div className="carousel-item">
                        <img
                          src="/assets/images/ecommerce/products/grid/pic4.png"
                          className="d-block img-fluid"
                          alt="Product view 4"
                        />
                      </div>
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <p className="mb-0 text-dark fw-semibold">
                      4.8 <span className="text-muted text-2xs ms-1">(120 Review)</span>
                    </p>
                  </div>
                  <h3 className="my-4">
                    ...
                    <div className="col-sm-5 mb-3">
                      ...
                      <div className="d-flex gap-2 align-items-center">
                        <div className="form-check p-0">
                          <input
                            className="btn-check form-check-input visually-hidden"
                            type="radio"
                            name="color-group"
                            id="check1"
                          />
                          <label
                            className="form-check-label btn btn-success btn-sm btn-icon waves-effect rounded-pill"
                            htmlFor="check1"
                          ></label>
                        </div>
                        <div className="form-check p-0">
                          ...
                          />
                          <label
                            className="form-check-label btn btn-info btn-sm btn-icon waves-effect rounded-pill"
                            htmlFor="check2"
                          ></label>
                        </div>
                        <div className="form-check p-0">
                          ...
                          />
                          <label
                            className="form-check-label btn btn-warning btn-sm btn-icon waves-effect rounded-pill"
                            htmlFor="check3"
                          ></label>
                        </div>
                        <div className="form-check p-0">
                          ...
                          />
                          <label
                            className="form-check-label btn btn-danger btn-sm btn-icon waves-effect rounded-pill"
                            htmlFor="check4"
                          ></label>
                        </div>
                      </div>
                    ...
                    <div className="col-sm-5 mb-3">
                      ...
                      <div className="d-flex gap-2 align-items-center">
                        <div className="form-check p-0">
                          ...
                          />
                          <label
                            className="form-check-label btn btn-outline-light btn-sm btn-icon waves-effect rounded-pill"
                            htmlFor="check6"
                          >
                  ...
                  <ul className="nav nav-underline card-header-tabs" id="myTabDefault" role="tablist">
                    <li className="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tabDefault"
                        data-bs-toggle="tab"
                        data-bs-target="#homeDefault"
                        type="button"
                        role="tab"
                        aria-controls="homeDefault"
                        aria-selected="true"
                        tabIndex={-1}
                      >
                        Review
                    ...
                    <li className="nav-item" role="presentation">
                      <button
                        className="nav-link"
                        id="profile-tabDefault"
                        data-bs-toggle="tab"
                        data-bs-target="#profileDefault"
                        type="button"
                        role="tab"
                        aria-controls="profileDefault"
                        aria-selected="false"
                      >
                        Descriptions
                      </button>
                    ...
                    <li className="nav-item" role="presentation">
                      <button
                        className="nav-link"
                        id="messages-tabDefault"
                        data-bs-toggle="tab"
                        data-bs-target="#messagesDefault"
                        type="button"
                        role="tab"
                        aria-controls="messagesDefault"
                        aria-selected="false"
                        tabIndex={-1}
                      >
                        About
                ...
                <div className="card-body">
                  <div className="tab-content">
                    ...
                    >
                      <div className="row">
                        <div className="col-lg-4 mb-3">
                          <div className="border rounded-2 p-3 mb-3">
                            ...
                            <div className="mt-3">
                              <div className="d-flex align-items-center justify-content-between">
                                <h6>
                                  5 <i className="fi fi-ss-star text-warning ms-1"></i>
                                </h6>
                            ...
                            <div className="mt-3">
                              <div className="d-flex align-items-center justify-content-between">
                                <h6>
                                  4 <i className="fi fi-ss-star text-warning ms-1"></i>
                                </h6>
                            ...
                            <div className="mt-3">
                              <div className="d-flex align-items-center justify-content-between">
                                <h6>
                                  3 <i className="fi fi-ss-star text-warning ms-1"></i>
                                </h6>
                            ...
                            <div className="mt-3">
                              <div className="d-flex align-items-center justify-content-between">
                                <h6>
                                  2 <i className="fi fi-ss-star text-warning ms-1"></i>
                                </h6>
                            ...
                            <div className="mt-3">
                              <div className="d-flex align-items-center justify-content-between">
                                <h6>
                                  1 <i className="fi fi-ss-star text-warning ms-1"></i>
                                </h6>
                          ...
                          <div className="mt-4">
                            <h6 class="mb-2">What Customers Like</h6>
                        ...
                        <div className="col-lg-8">
                          <div className="border rounded-2 p-3 mb-3">
                            ...
                            <p className="mb-0">
                              The visuals are stunning and very smooth. The lightweight design makes it super
                              comfortable to use for long sessions. Totally worth the price.
                            </p>
                          </div>
                          <div className="border rounded-2 p-3 mb-3">
                            <div className="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                            ...
                            <p className="mb-0">
                              Bought it last week. The audio feels immersive and the build quality is strong. Just
                          ...
                          <div className="border rounded-2 p-3 mb-3">
                            ...
                            <p className="mb-0">
                              This is by far the best VR headset I’ve ever owned. Easy setup and the wireless
                          ...
                          <div className="border rounded-2 p-3 mb-3 ms-5">
                            ...
                            <div className="mt-3">
                              ...
                              <textarea className="form-control" id="Reply" rows={2} />
                            </div>
                          </div>
                    ...
                    <div
                      ...
                      id="profileDefault"
                      role="tabpanel"
                      aria-labelledby="profile-tabDefault"
                      tabIndex={0}
                    >
                      <p>
                    ...
                    <div
                      ...
                      id="messagesDefault"
                      role="tabpanel"
                      aria-labelledby="messages-tabDefault"
                      tabIndex={0}
                    >
