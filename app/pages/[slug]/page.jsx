...
function loadTemplateBodyHtml(slug) {
  ...
  try {
    ...
    if (error?.code === "ENOENT") {
      return `<div style="padding:2rem;font-family:system-ui, sans-serif;text-align:center;">
        <h1>404</h1>
        <p>Template not found: pages/${cleanSlug}.html</p>
      </div>`;
    }
    throw error;
  }
  ...
  if (!bodyMatch) return `<div>Missing &lt;body&gt; in pages/${slug}.html</div>`;
  ...
  bodyHtml = bodyHtml.replaceAll('href="pages/', 'href="/pages/');
